...
<body>
	...
	<div class="container p-3">
		<p class="text-center mt-2 mb-5 fs-2 myP-color">Some key Features
			of our Hospital Management System</p>
		<div class="row">
			<!-- 1st col -->
	...
	<div class="container p-2">
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="card my-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. Tanmaya </p>
			...
			<div class="col-md-3">
				<div class="card my-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. Anchal</p>
						<p class="fs-7">(Chief Doctor)</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-3">
				<div class="card my-card">
					<div class="card-body text-center">
						<img alt="" src="img/doctor.jpg" height="300px" width="230px">
						<p class="fw-bold fs-5">Dr. Suryasoni</p>
						<p class="fs-7">(Dean)</p>
					</div>
				</div>
			</div>
